        ...
        >
          ...
          <form id="generation-form" noValidate>
            ...
            >
              ...
              <div className="flex items-start justify-between gap-1.5 max-[520px]:grid max-[520px]:grid-cols-[minmax(0,1fr)_auto]">
                <div
                ...
                >
                  <Button
                    type="button"
                    className="preset-chip min-h-11"
                    variant="outline"
                    size="sm"
                    data-prompt="A person walks forward confidently."
                  >
                    Walk
                  </Button>
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    data-prompt="A person performs a joyful dance."
                  >
                    Dance
                  </Button>
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    data-prompt="A person crouches down and stands back up."
                  >
                    Crouch
                  </Button>
                </div>
            ...
            <Card
              ...
              hidden
            >
              <CardHeader className="grid grid-cols-[minmax(0,1fr)_auto] items-center">
                <CardTitle id="generation-stage">
                  Preparing model
                </CardTitle>
                <span
                  className="text-xs text-muted-foreground"
              ...
              <CardContent className="flex flex-col gap-2">
                ...
                <CardDescription id="generation-note">
